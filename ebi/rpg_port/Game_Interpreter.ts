...
class Game_Interpreter
  ...
  //--------------------------------------------------------------------------
  public setup_reserved_common_event
  ...
  //     param2 : アクターまたは変数 ID
  //--------------------------------------------------------------------------
  public iterate_actor_var(param1, param2)
    if param1 == 0
  ...
  //--------------------------------------------------------------------------
  public iterate_actor_index(param)
    if param < 0
      $game_party.members.each {|actor| yield actor }
    else
  ...
  //     param : 0 以上ならインデックス、-1 なら全体
  //--------------------------------------------------------------------------
  public iterate_enemy_index(param)
    if param < 0
  ...
  //--------------------------------------------------------------------------
  public iterate_battler(param1, param2)
  ...
  //--------------------------------------------------------------------------
  public operate_value(operation, operand_type, operand)
  ...
  // ● アイテム選択のセットアップ
  //--------------------------------------------------------------------------
  public setup_item_choice(params)
  ...
  public command_413
    begin
      @index -= 1
    } until @list[@index].indent == @indent
  }
  //--------------------------------------------------------------------------
  // ● ループの中断
  //--------------------------------------------------------------------------
  ...
  // ● 変数オペランド用ゲームデータの取得
  //--------------------------------------------------------------------------
  public game_data_operand(type, param1, param2)
    case type
    when 0  // アイテム
  ...
  // ● 変数の操作を実行
  //--------------------------------------------------------------------------
  public operate_variable(variable_id, operation_type, value)
    begin
      case operation_type
      when 0  // 代入
