...
module ebi.game {
    ...
    export class Input {
        ...
        public static beginTouch(touchX: number, touchY: number) {
            touchX_   = touchX;
            touchY_   = touchY;
            isTouched_  = true;
        ...
        public static moveTouch(touchX: number, touchY: number) {
            touchX_   = touchX;
            touchY_   = touchY;
            lastAction_ = "touchMoved";
        }

        public static endTouch(touchX: number, touchY: number) {
            touchX_   = touchX;
            touchY_   = touchY;
