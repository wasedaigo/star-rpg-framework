...
module ebi.rpg.map {
    export class MapCharacter {
        ...
        private map_: Map;
        private collisionObject_: ebi.rpg.map.collision.CollisionObject;
        ...
        public set ignoreTile(ignore: bool) {
            this.collisionObject_.setIgnoreCategory(ebi.rpg.map.collision.Category.Tile, ignore);
        }

        public set ignoreCharacter(ignore: bool) {
            this.collisionObject_.setIgnoreCategory(ebi.rpg.map.collision.Category.Character, ignore);
        }
